...
activities = {
    ...
    "Swimming Club": {
        "description": "Lap training, techniques, and local competitions",
    ...
    "Art Club": {
        ...
        "max_participants": 16,
        "participants": ["maria@mergington.edu", "ethan@mergington.edu"]
    },
    "Drama Club": {
    ...
    "Science Club": {
        ...
        "max_participants": 20,
        "participants": ["lily@mergington.edu", "benjamin@mergington.edu"]
    }
}
